...
export const InstancesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    addLogMessageToInstance: async (
      ...
      const localVarPath = `/recordm/instances/{id}/log`.replace(`{${"id"}}`, encodeURIComponent(String(id)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    deleteInstance: async (
      ...
      const localVarPath = `/recordm/instances/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(id)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    getNewInstance: async (
      ...
      const localVarPath = `/recordm/instances/empty/definition/{definitionId}`.replace(
        `{${"definitionId"}}`,
...
export const InstancesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    downloadFile(
      ...
      return localVarFp
        .downloadFile(id, fieldDefinitionId, filename, disposition, options)
    ...
    updateInstance(id: number, instance: Instance, acceptOutdated?: boolean, options?: any): AxiosPromise<void> {
      return localVarFp
        .updateInstance(id, instance, acceptOutdated, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Upload a file to be used as a value for a $file field
...
export class InstancesApi extends BaseAPI {
  ...
  public addLogMessageToInstance(id: number, body?: string, options?: AxiosRequestConfig) {
    return InstancesApiFp(this.configuration)
      .addLogMessageToInstance(id, body, options)
      .then((request) => request(this.axios, this.basePath))
  }
  ...
  public deleteInstance(id: number, ignoreRefs?: boolean, options?: AxiosRequestConfig) {
    return InstancesApiFp(this.configuration)
      .deleteInstance(id, ignoreRefs, options)
      .then((request) => request(this.axios, this.basePath))
  }
  ...
  public getInstance(id: number, ifNoneMatch?: string, options?: AxiosRequestConfig) {
    return InstancesApiFp(this.configuration)
      .getInstance(id, ifNoneMatch, options)
      .then((request) => request(this.axios, this.basePath))
  }
  ...
  public getNewInstance(definitionId: number, withDefaults?: boolean, options?: AxiosRequestConfig) {
    return InstancesApiFp(this.configuration)
      .getNewInstance(definitionId, withDefaults, options)
      .then((request) => request(this.axios, this.basePath))
  }
  ...
  public uploadFile(id: string, fieldDefinitionId: string, file?: object, options?: AxiosRequestConfig) {
    return InstancesApiFp(this.configuration)
      .uploadFile(id, fieldDefinitionId, file, options)
      .then((request) => request(this.axios, this.basePath))
  }
}
